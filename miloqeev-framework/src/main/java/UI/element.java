...
public class element {
    ...
    public static WebElement findElementBy(String locatorType, String locatorValue){
        ...
        try{
            switch (locatorType){
                case "id": tmp = browserManagement.driver.findElement(By.id(locatorValue));
                    break;
                case "name": tmp = browserManagement.driver.findElement(By.name(locatorValue));
                    break;
                case "class": tmp = browserManagement.driver.findElement(By.className(locatorValue));
                    break;
                case "xpath": tmp = browserManagement.driver.findElement(By.xpath(locatorValue));
                    break;
                default: break;
            }
            logInfo.pass("Found element located by '" + locatorType + "=" + locatorValue + "' and saved to variable");
        } catch (AssertionError | Exception e){
            testStepHandle("FAIL", browserManagement.driver, logInfo.fail("Could not find element located by '" + locatorType + "=" + locatorValue + "'"), e);
        }
        return tmp;
    }
...
//    }
    ...
    public static void inputText(String locatorType, String locatorValue, String text){
        try {
            ...
            testStepHandle("FAIL", browserManagement.driver, logInfo.fail("Could not enter text in element located by '" + locatorType + "=" + locatorValue + "'"), e);
        }
    }
...
//
    ...
    public static void clickElement(String locatorType, String locatorValue){
        try {
            ...
            testStepHandle("FAIL", browserManagement.driver, logInfo.fail("Element located by '" + locatorType + "=" + locatorValue + "' was not clickable"), e);
        }
    }
//
//    /**
