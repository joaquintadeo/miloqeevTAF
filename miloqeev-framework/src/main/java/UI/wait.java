...
//    }
    ...
    public static void waitUntilPageContains(String text, int timeout){
        WebDriverWait wait = new WebDriverWait(browserManagement.driver, timeout);
        try {
            ...
            testStepHandle("FAIL",browserManagement.driver,logInfo.fail("Text: '" + text + "' did not appear after " + timeout + " seconds"),e);
        }
    }
